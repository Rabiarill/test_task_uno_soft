# test_task_uno_soft
## Как запустить
1. Скачать файл (https://github.com/PeacockTeam/new-job/releases/download/v1.0/lng-big.7z) разархивировать и поместить в папку с ресурсами 
2.  ```bash
    mvn package
    java -jar target/test_task_uno_soft-1.0-SNAPSHOT.jar src/main/resources/lng-big.csv -Xmx1G
    ```
## Задание
С помощью Java:
